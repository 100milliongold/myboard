...
public class Paging {
    ...
    private int nevSize; // 출력되는 페이징 갯수
	 ...
	 * @param nevSize
	 */
	public void setNevSize(int nevSize) {
		this.nevSize = nevSize;
	}
    ...
    private void makePaging() {
        ...
        if (this.nevSize == 0) this.setNevSize(10);
        ...
        int startPage = ((pageNo - 1) / this.nevSize) * this.nevSize + 1; // 시작 페이지 (페이징 네비 기준)
        int endPage = startPage + this.nevSize - 1; // 끝 페이지 (페이징 네비 기준)
