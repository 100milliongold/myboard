...
SET DEFINE OFF;
Insert into BOARD.BOARD_PRO (BNO,SUBJECT,CONTENT,WRITER,REG_DATE,HIT) values (9,'ㅂ','ㅁㄴㅇㅁㄴㅇ','ㅁㄴㅇ',to_date('17/05/19','RR/MM/DD'),9);
...
Insert into BOARD.BOARD_PRO (BNO,SUBJECT,CONTENT,WRITER,REG_DATE,HIT) values (1,'ㅁㄴㅇ',null,'ㅁㄴㅇ',to_date('17/05/19','RR/MM/DD'),16);
Insert into BOARD.BOARD_PRO (BNO,SUBJECT,CONTENT,WRITER,REG_DATE,HIT) values (4,'ㅁㄴㅇ','dasdasd','ㅁㄴㅇ',to_date('17/05/19','RR/MM/DD'),1);
Insert into BOARD.BOARD_PRO (BNO,SUBJECT,CONTENT,WRITER,REG_DATE,HIT) values (7,'ㅋㅋㅋㅋㅋ','난 역시 천재야','ㅁㄴㅇ',to_date('17/05/19','RR/MM/DD'),7);
...
SET DEFINE OFF;
Insert into BOARD.MEMBER (USERNAME,PASSWORD,NAME,IS_ACCOUNT_NON_EXPIRED,IS_ACCOUNT_NON_LOCKED,IS_CREDENTIALS_NON_EXPIRED,IS_ENABLED) values ('asd','asd','asd',null,null,null,null);
--------------------------------------------------------
